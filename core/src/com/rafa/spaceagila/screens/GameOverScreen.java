...
public class GameOverScreen implements Screen, ApplicationListener, InputProcessor {
    ...
    public GameOverScreen(SpaceAgila game, int score) {
        this.game = game;
        this.score = score;

        //load textures and fonts
        gameOverBanner = new Texture("youdead.png");
    ...
    public void render(float delta) {
        ...
        game.batch.draw(gameOverBanner, SpaceAgila.WIDTH_DESKTOP / 2 - BANNER_WIDTH / 2, SpaceAgila.HEIGHT_DESKTOP - BANNER_HEIGHT - 150, BANNER_WIDTH, BANNER_HEIGHT);
